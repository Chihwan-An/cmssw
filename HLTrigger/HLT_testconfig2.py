...
# with command line options: Phase2 -s L1P2GT,HLT:75e33 --conditions auto:phase2_realistic_T33 --geometry ExtendedRun4D110 --era Phase2C17I13M9 --nThreads 64 -n 1000 --no_exec --customise SLHCUpgradeSimulations/Configuration/aging.customise_aging_1000 --eventcontent FEVTDEBUGHLT --filein=file:/gv0/Users/youngwan_public/RelValTTbar_Run4/TTBar/91dd3e06-b9d0-4648-8c21-594785108b8b.root --inputCommands=keep *, drop *_hlt*_*_HLT, drop triggerTriggerFilterObjectWithRefs_l1t*_*_HLT --python_filename HLT_testconfig2.py --processName=HLTX
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:/gv0/Users/youngwan_public/RelValTTbar_Run4/TTBar/91dd3e06-b9d0-4648-8c21-594785108b8b.root'),
